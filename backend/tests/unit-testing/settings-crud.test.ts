...
describe('Database CRUD tests for settings', () => {
    ...
    it('change dates', async () => {
        await setDates(new Date("2026-02-02T00:00:00.000Z"),new Date("2026-02-09T00:00:00.000Z"));
        ...
        await setDates(new Date("2026-01-02T00:00:00.000Z"),new Date("2026-01-09T00:00:00.000Z"));
